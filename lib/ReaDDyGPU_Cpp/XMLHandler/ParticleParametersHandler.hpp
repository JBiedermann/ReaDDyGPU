...
class ParticleParametersHandler : public DefaultHandler
{
public:
    // -----------------------------------------------------------------------
    //  Constructors and Destructor
    // -----------------------------------------------------------------------
    ParticleParametersHandler(Simulation *simulation);
    ~ParticleParametersHandler();

    Simulation *simulation;
    stringstream charBuffer;
    ParticleType particleType;
    vector<vector<double> > collisionRadii;
    string collisionRadiusPartnerType;
    double collisionRadiusValue;
    bool collisionRadiusParsing;
